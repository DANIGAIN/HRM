...
export const fullnameValidation = z
    .string()
    .trim()
    .max(255, { message: "Full name must not more than 255 characters !" })
    .regex(/^[a-zA-Z0-9_]+$/, "Full contain special character !")
...
export const passwordValidation = z
    ...
    .max(255, { message: "Password must not more than 255 characters !" })
    .regex(/^(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z\d]+$/, "Least one letter and one number")
...
export const is_verifiedValidation = z.boolean()
